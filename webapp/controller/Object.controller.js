sap.ui.define([
	...
	return BaseController.extend("com.sodogan.manage_products.controller.Object", {
		...
		_onBindingChange: function () {
			...
			if (!oElementBinding.getBoundContext()) {
				this.getRouter().getTargets().display("objectNotFound_target");
				return;
			}
