sap.ui.define([
	"sap/ui/test/Opa5",
	"com/sodogan/manage_products/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.sodogan.manage_products.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.sodogan.manage_products",
					async: true
				},
				hash: oOptions.hash,
